...
def get_link_entity(mention,id,entity_id,id_entity):
    ...
    if mention in entity_id:
        ...
        # if id not in entity_id[mention]:
        #     if id_entity[id] in entity_id:
...
def get_input():
            ...
            for men in mention_data:
                ...
                if kb_id != 'NIL':
                    ...
                    for id in link_id:
                        ...
                        indice, segment = tokenizer.encode(first=text,second=kb_text,max_len=384)
    ...
    for k in inputs:
        ...
        print(inputs[k][1])
    pd.to_pickle(inputs,'data/train_input_bert_final_384.pkl')
...
if __name__ == '__main__':
    get_input()
    get_test_input('result/eval_ner_result.json', 'data/eval_link_binary_bert_384.json')
